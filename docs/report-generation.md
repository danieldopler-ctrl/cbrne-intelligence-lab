...
It does not add conclusions, change threat or misuse review levels, transmit a report, or call an
AI service.
...
| Domain isolation | CHEM, BIO, and AI misuse alerts cannot appear together in one report. |
...
levels and remain fixture-conformance records only.
